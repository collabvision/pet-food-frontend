...
export const orderService = {
  ...
  adminUpdateStatus: (orderId, orderStatus, note) =>
    api.patch(`/orders/admin/${orderId}/status`, { orderStatus, note }),
};
...
export const returnService = {
  request: (orderId, reason, comments, items) =>
    api.post('/returns', { orderId, reason, comments, items }),
  ...
  adminUpdateStatus: (returnId, status, adminComment) =>
    api.patch(`/returns/admin/${returnId}/status`, { status, adminComment }),
};
